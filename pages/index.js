...
export async function getServerSideProps({req, res, query}) {
  const categoryResponse = await fetch(`https://musicserver1.herokuapp.com/category`)
  ...
  if(query.categoryId) {
    const audioResponse = await fetch(`https://musicserver1.herokuapp.com//music?` + new URLSearchParams({...queryTail})) 
